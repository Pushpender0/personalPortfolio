...
const applyTheme = () => {
  // Get user-preferred theme from localStorage
  ...
  if (!selectedTheme) {
    ...
    document.body.classList[prefersDarkScheme ? "add" : "remove"](darkTheme);
    themeButton.classList[prefersDarkScheme ? "add" : "remove"](iconTheme);
  } else {
...
// animation on home h1
function breakTheText() {
  var h1 = document.querySelector("#anime")
